...
This note keeps three related states separate.  The accepted v4.2 combined result uses
...
different lower support edge.  Version 4.9.7 tests a new full-2016 lower-support
prescription but does not freeze one, so no new observed or combined state follows.
The engineering data share the baseline tracker used in the published prompt searches;
the 2021 data were recorded with the upgraded tracker and positron hodoscope. Although
the 2019 run used the same upgraded detector, no 2019 data enter these analyses.
...
40--300~MeV for 2021.  Version 4.9.7 tests 28--33~MeV lower edges for full-2016
inference, with 34~MeV as a geometry control, but no edge passes its frozen Phase-1
rule.  Table~\ref{tab:v4p9p7-2016-phase1} records that stopped validation state.
