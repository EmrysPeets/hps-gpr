...
follow the published and internal engineering-run summaries. For 2021, the baseline
entries follow the full-analysis-note preselection
\cite[Sec.~4.8, Table~38 and App.~A]{HPS2021FullAnalysisNote}. The prompt entries list
only additional requirements established for the v16 prompt-TC production used for
the native 10\% v4.9.5 source.}
...
\Pro no additional v16 requirement. \\
...
\Pro the v16 prompt-TC source requires $p_{\rm sum}>2.8~\mathrm{GeV}$. \\
...
\Pro no additional 2D-hit requirement is established; the available v16 field counts
3D hits. \\
...
\Pro no additional v16 timing requirement. \\
...
\Pro no additional v16 offline coincidence requirement. \\
...
\Pro no additional v16 vertex-fit $\chi^2$ requirement. \\

Positron cluster energy &
\Pre ---\newline \Pro --- &
\Pre ---\newline \Pro --- &
\Pre full-note sanity cut $E^{\rm clu}_{e^+}>0.2~\mathrm{GeV}$.\newline
\Pro no additional v16 positron-cluster threshold. \\
...
\Pro no additional v16 cWAB requirement. \\
...
\Pro no additional v16 multiplicity requirement. \\
\end{longtable}
\endgroup
