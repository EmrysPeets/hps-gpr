...
The first stage reuses 100 background-only pseudoexperiments generated from the fitted
source spectrum in the four-exposure study; no new pseudo-data are generated. At each support edge,
matched-reference extractions
...
original rule, an edge was rejected when any mass--injection combination had
...
checks. With the criterion already fixed, we chose 36--300~MeV for the subsequent
