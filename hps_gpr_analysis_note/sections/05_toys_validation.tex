...
for the v4.1 candidate. The current physics-facing simultaneous limit is presented
in Section~\ref{sec:results-v4-combined-limit}. The older observed-equivalent
full-sample projection remains in
Figure~\ref{fig:app-legacy-projections} as a planning study rather than a v4.1 result.
