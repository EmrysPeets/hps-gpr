...
In each panel, the legend reports the same bin-integral $\chi^2/\mathrm{ndof}$
convention used by the macro when ranking the candidate functions.
...
visible at the spectrum level before the GPR scan is run over the resulting toys.}
