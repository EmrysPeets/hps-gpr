...
Table~\ref{tab:dataset-summary} summarizes the run periods, analyzed samples, and
...
\toprule
Run period & Beam energy & Sample used here & Prompt scan range \\
\midrule
...
fully unblinded 2015 engineering run anchors the methodology validation; the 2016
input is the current 10\% development sample; and the 2021 input is the regenerated
1\% validation sample. The quoted ranges are those frozen for the July 2026
pre-unblinding 90\% CL upper-limit candidate: \SIrange{19}{90}{MeV} for 2015,
\SIrange{39}{180}{MeV} for 2016, and \SIrange{50}{250}{MeV} for 2021. The corresponding
published prompt searches scanned \SIrange{19}{81}{MeV} in 2015 and
\SIrange{39}{179}{MeV} in 2016
...
The regenerated 2021 input is \path{final_1pct_invM.root}; it supersedes the earlier
low-$p_{\mathrm{sum}}$ development histogram used in preceding note drafts. The 2016
10\% and 2021 1\% samples are constructed as development streams spread across
their respective running periods rather than as contiguous end-of-run blocks, so they
sample run-period conditions while keeping most of each campaign dataset blinded for
the later unblinding stages.
...
the same spectra in absolute events per MeV, with the published engineering-run windows
and the frozen 2021 candidate range highlighted.
...
count and bin width, so the overlay compares spectral shape rather than sample size.}
...
regions show the published 2015 and 2016 prompt-search windows and the v3 2021
candidate range, \SIrange{50}{250}{MeV}; the 2021 panel is plotted
