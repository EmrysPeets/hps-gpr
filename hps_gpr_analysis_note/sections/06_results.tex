...
upper-limit products here once the 2015+2016 10\%+2021 1\% combination is available.
The discussion should reuse the shared-likelihood logic of
Section~\ref{sec:combination}.}
...
\begin{subfigure}[t]{0.48\linewidth}
  ...
  \caption{$\eps^2$ upper limits.}
\end{subfigure}
\caption{Planned location for the 2015+2016 10\%+2021 1\% combined upper limits.}
