...
configurations. In v3 the 2015 and 2016 ranges remain close to their published prompt
searches, with only the 2015 upper boundary extended from 81 to \SI{90}{MeV}, while the
2021 study reaches \SI{250}{MeV}. A stable GP model therefore matters both for
...
the combined 2015+2016 10\%+2021 1\% study is presented as the v3 pre-unblinding
shared-coupling candidate.
...
not enter the v3 prompt-resonance analysis.
