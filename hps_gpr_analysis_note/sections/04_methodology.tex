...
result is used to qualify the v4.1 candidate.
...
The configurations continue to retain the dataset-statistics floor on
$\ell_{\max,d}$ so that the ceiling does not become artificially small where the
local resolution is exceptionally tight. Alternative upper bounds,
