...
The local-significance mapping of Eq.~\eqref{eq:p0-single} is treated asymptotically
throughout the production scan. For upper limits, the same bounded statistic
...
exclusion tests and is not used as a search statistic.
...
$p_{\mathrm{weak}}$, and $p_{\mathrm{two}}=2\min(p_{\mathrm{strong}},p_{\mathrm{weak}})$
is used only as a symmetric diagnostic summary.}
