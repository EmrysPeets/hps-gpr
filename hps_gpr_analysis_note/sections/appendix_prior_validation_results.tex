...
older plots the status of v4 result figures. In particular, the closure panels below
...
must not be combined numerically with the v4 result. Each subsection records the
