...
older plots the status of v4.2 result figures. In particular, the closure panels below
...
must not be combined numerically with the v4.2 result. Each subsection records the
