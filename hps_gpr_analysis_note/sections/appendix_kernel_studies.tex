...
\begin{figure}
    \centering
    \includegraphics{hps_gpr_analysis_note/appendix_figs/2016_10pct_whitenoisefit.png}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{hps_gpr_analysis_note/appendix_figs/piecewise_diagram.png}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{hps_gpr_analysis_note/appendix_figs/signal_yield_2016_10.png}
