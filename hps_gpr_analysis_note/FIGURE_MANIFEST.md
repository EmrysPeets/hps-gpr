...
| Bundle path | Original source | Status | Notes |
| --- | --- | --- | --- |
| `toy_generation_figs/funcform_fit_2015.png` | Generated by `root_macros/funcform/make_func_data_output_2015.C` | provisional | Dataset-specific 2015 analytic functional-form overlay, including the endpoint-aware compact form and fallback candidates used for toy generation. |
...
| `toy_generation_figs/funcform_fit_2016.png` | Generated by `root_macros/funcform/make_func_data_output_2016.C` | provisional | Dataset-specific 2016 analytic functional-form overlay, showing the thresholded generalized-gamma/log-polynomial family and alternates. |
...
| `toy_generation_figs/funcform_fit_2021.png` | Generated by `root_macros/funcform/make_func_data_output_2021.C` | provisional | Dataset-specific 2021 analytic functional-form overlay, showing the tuned Sigmoid×PowExp×ExpQuad family and alternates. |
