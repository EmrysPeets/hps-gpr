...
the upgraded-detector 1\% validation subset actually used by the present GPR workflow.
For 2021, the baseline entries follow the full-analysis-note preselection
\cite[Sec.~4.8, Table~38 and App.~A]{HPS2021FullAnalysisNote}; the prompt column records
the extra prompt-tight requirement applied by the present production histogram.}
