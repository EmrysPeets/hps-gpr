...
with nominal local significance about 2.76. The extension makes 92~MeV the next separated positive feature of the
full union, now containing all three campaigns. The earlier 21~MeV
comparison, containing only 2015, remains useful for the lower-edge diagnostic.
...
2015 full & 51 (+3.14) & 92 (+2.59) & 19 ($-3.21$)\\
2016 full & 90 (+3.42) & 117 (+3.28) & 102 ($-4.50$)\\
2021 10\% & 78 (+2.81) & 65 (+2.40) & 71 ($-4.02$)\\
Combined union & 66 (+2.76) & 92 (+2.52) & 72 ($-3.49$)\\\bottomrule
\end{tabular}
...
92~MeV three-campaign fit has nominal local significance 2.52.}
\end{table}
...
\widefig{0.98}{../figures/v5_extraction_combined_92.pdf}{The 92~MeV common-coupling fit now includes 2015, 2016 and 2021.
It gives $\widehat\epsilon^2=3.096\times10^{-6}$ and nominal local
$Z=2.520$. Top: observed counts, sideband GP mean and profiled
signal-plus-background prediction. Bottom: observed counts minus that same
unprofiled GP mean, with the fitted signal, the profiled-background shift,
and their sum displayed separately. The last column sums common whole bins
from the three campaigns and has no separate fit. Counting errors and the zero-centered
GP constraint band omit post-fit covariance. The large standalone 2015
preferred rate is not the signal height imposed by this common fit;
Section~\ref{sec:v5-rate-consistency} explains the comparison.}
...
\widefig{0.98}{../figures/v5_extraction_2015_peaks.pdf}{The earlier separated 2015 regions at 51 and 21~MeV, with the added
92~MeV region from the extension. The 21~MeV feature is close to the lower
search endpoint. All residuals subtract the unprofiled GP mean; the fitted
signal, the background displacement and their sum are shown separately.
Bars show counting errors and shading shows the GP constraint width, not a
post-fit signal confidence band. The 92~MeV panel is an individual 2015 fit;
its preferred amplitude differs from the common-rate extraction in
Figure~\ref{fig:v5-extraction-combined92}.}
