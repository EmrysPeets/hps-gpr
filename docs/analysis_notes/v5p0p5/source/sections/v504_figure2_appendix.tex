...
100~MeV. The 2019 dataset is the measured nominal 1\% spectrum selected with
...
is solved numerically. The three- and four-campaign projections use
the same implementation. No inverse-limit or significance combination is used.
This calculation for Figure 2 changes the three-campaign numerical endpoints
by at most 2.51\% relative to the nominal results in the note; the earlier observed
...
and let $f_y$ be the ratio of full exposure to the analyzed exposure. The plotted
coordinate is
\begin{equation}
...
\end{equation}
The muon curve uses the WP25 residual $38(63)\times10^{-11}$
