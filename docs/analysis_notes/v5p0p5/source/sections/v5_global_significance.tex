...
The paper and its \texttt{sigcorr} implementation assume that the signed
likelihood-root field itself has null mean zero and unit variance.
Our stress-centered coordinate and positive-fit gate below extend that
construction; they do not acquire the paper's discovery interpretation
automatically. Section~\ref{sec:v5-global-results} reports an executable
comparison with the pinned official code.
...
correlation. The original grids contained 72, 142 and 201 hypotheses.
Version 5.0.5 retains the 82 integer masses over 19--100~MeV for 2015; the
2016 and 2021 integer ranges remain 39--180 and 50--250~MeV.
...
19--38~MeV, 2015+2016 at 39--49~MeV, all three at 50--100~MeV,
2016+2021 at 101--180~MeV, and 2021 at 181--250~MeV. The original independent
constituent streams form 1,000 joint experiments. The extension reuses their
first 256 complete spectra at every mass, with
...
\end{tabular}
\caption{Historical, pre-extension 200,000-field conditional significance-GP diagnostics under the
...
Version 5.0.2 extends the profiled 2016 and combined Gaussian ensembles
to 2,000,000 fields each. Its repository-audit revision additionally uses
importance sampling to resolve the remaining finite-grid Gaussian tails;
Appendix~\ref{app:v504-global-study} defines the estimator and its checks.
The updated 2015 and combined fields use 200,000 ordinary fields plus
40,000 conditional-mixture draws at every positive-fit threshold with
standardized score at least 3.5. Their direct checks use 256 coherent scans.
Appendix~\ref{app:v504-extension} gives the enlarged-grid construction.
The direct 1,000-scan checks and the archived values in this table remain
their original benchmark.
