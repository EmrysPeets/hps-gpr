...
The corrected re-analysis retained the 2015 detector response and radiative fraction
...
Shared counts, mass resolution and radiative fraction explain part of the
