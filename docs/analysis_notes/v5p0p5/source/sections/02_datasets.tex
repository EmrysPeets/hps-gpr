\section{HPS apparatus and datasets}
\label{sec:datasets}
...
The current analysis uses full 2015 and 2016 engineering-run samples and the
released 2021 10\% physics-run sample. The same fit settings for each campaign
enter both standalone and shared-coupling results. The engineering data share
...
2016 datasets are the full engineering-run samples; the 2021 dataset is the distributed
...
The 36--300~MeV support was first developed in a separate 2021 study and was
...
The 2015 and 2016 samples are fully unblinded. The 2021 dataset is distributed across
...
\begin{figure}[H]
\centering
\graphicorplaceholder{0.98\linewidth}{../figures/v5_dataset_mass_distributions_log.pdf}
\caption{Invariant-mass distributions for the 2015, 2016 and 2021 datasets, shown in
events per MeV with original bin widths of 0.05, 0.05 and 0.125~MeV, respectively. Gray shading
marks the current GP supports, including 36--300~MeV for 2021, and dashed lines
bound the narrower interval in which signal hypotheses are tested. The mass-dependent
...
invariant-mass spectrum. The next section explains the selections and the two quantities
