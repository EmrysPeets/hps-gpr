...
\caption{Invariant-mass distributions from the hash-verified released inputs, shown in
events per MeV at the native input widths of 0.05, 0.05 and 0.125~MeV. Gray shading
