...
MEMORY="${MEMORY:-6G}"
CONFIG="${CONFIG:-study_configs/config_2016_extraction_display_v15p8.yaml}"
DATASET="${DATASET:-2016}"
BASE_OUTPUT="${BASE_OUTPUT:-outputs/extraction_display_2016_10pct_batch}"
LOGDIR="${LOGDIR:-logs/extraction_display_2016_10pct}"
...
for Z in "${SIGMA_LIST[@]}"; do
  sbatch <<EOF
#!/bin/bash
#SBATCH --job-name=hps_exdisp_2016_z${Z}
